...
const configuration = {
  ...
  Auth: {
    ...
    communicationKey: secretKey, // The secret key used to validate an incoming request
  },
  Pruning: {
    dontShowServersOnSameIp: false, // When a client requests the server list, remove the server they're on from the list.
    inactiveServerRemovalMinutes: 15, // How many minutes a server should be considered inactive before it's removed from the list.
